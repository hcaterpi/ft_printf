...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/22 14:46:05 by hcaterpi          #+#    #+#             */
/*   Updated: 2019/12/22 15:00:29 by hcaterpi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_display_binary(va_list arguments, t_format *specifiers)
{
	...
	str = ft_itoa_base(number, 'a');
	length = ft_strlen(str);
	if ((counter = 0) && sign && length++ && specifiers->flag_zero)
